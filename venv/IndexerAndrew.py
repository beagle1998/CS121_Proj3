...
INDEX_DICT = {}
#DOC_ID_DICT = {}
directory="D:\\Repos\\121\\CS121_Proj3\\testFolder"
doc_counter=0
partial_counter=0
NumOfDocs=0
ps=PorterStemmer()
...
def Tokenizer(file):
    ...
    #          ff=filter(filter_stops,ff) # stop words             DO WE NEED THIS???
          ...
          #      print(word) and word in words.words()
                try:
                    if(word.isalnum() and is_ascii(word)):
                        if(word in dict2):
                    ...
                    print("ERROR Reading Word or Non Ascii character: "+ str(Exception))
        except:
            print("ERROR OPENING THIS FILE: "+ str(file))
            pass
